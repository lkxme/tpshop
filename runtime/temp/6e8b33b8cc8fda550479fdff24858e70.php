<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"E:\phpStudy\WWW\tpshop\public/../application/home\view\public\register.html";i:1533736135;}*/ ?>
				...
				<form action="" method="post">
					<ul>
						...
						<li>
							...
							<input type="text" class="txt" name="phone" style="width:100px"/>
							<input type="button" id="sendSms" value="发送短信">
						</li>
						<li>
							<label for="">验证码：</label>
							<input type="text" class="txt" name="phoneCaptcha" />
						...
						<li class="checkcode">
							...
							<img src="<?php echo captcha_src(); ?>" id="captcha" alt="">

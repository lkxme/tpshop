<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"G:\www.shop.com\public/../application/admin\view\category\upd.html";i:1533111494;}*/ ?>
    ...
    <div class="formbody">
        ...
        <form action="" method="post">
            ...
            <ul class="forminfo">
                <li>
                    <label>分类名称</label>
                    <input name="cat_name" value="<?php echo $cat['cat_name']; ?>" placeholder="请输入分类名称" type="text" class="dfinput" /><i></i>
                </li>
                 <li>
                    <label>所属父分类</label>

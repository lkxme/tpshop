<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"E:\phpStudy\WWW\tpshop\public/../application/admin\view\user\index.html";i:1533291537;}*/ ?>
        ...
        <table class="tablelist">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('/admin/user/upd',['user_id'=>$user['user_id']]); ?>" class="tablelink">编辑</a> 
                        <a href="<?php echo url('/admin/user/del',['user_id'=>$user['user_id']]); ?>" onclick="return confirm('确认删除？')" class="tablelink"> 删除</a>
                    </td>
                </tr>

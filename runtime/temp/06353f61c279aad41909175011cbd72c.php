<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\phpStudy\WWW\tpshop\public/../application/home\view\goods\detail.html";i:1534093732;}*/ ?>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="/static/upload/<?php echo $goodsInfo['goods_img'][0]; ?>" class="jqzoom" rel="gal1">
						 <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="/static/upload/<?php echo $goodsInfo['goods_middle'][0];?>" alt="" />
							  <!-- 第一幅图片的中图 -->
						</a>
					</div>
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<li <?php echo $k==0?'class="cur"':''; ?>>
									...
									<a <?php echo $k==0?'class="zoomThumbActive"':'';?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/static/upload/<?php echo $m?>',largeimage: '/static/upload/<?php echo $goodsInfo['goods_img'][$k];?>'}"><img src="/static/upload/<?php echo $goodsInfo['goods_thumb'][$k]; ?>" ></a>
								</li>
							<?php endforeach;?>
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo config('home_static'); ?>/images/preview_m2.jpg',largeimage: '<?php echo config('home_static'); ?>/images/preview_l2.jpg'}"><img src="<?php echo config('home_static'); ?>/images/preview_s2.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
									rel="{gallery: 'gal1', smallimage: '<?php echo config('home_static'); ?>/images/preview_m3.jpg',largeimage: '<?php echo config('home_static'); ?>/images/preview_l3.jpg'}">
	    							<img src="<?php echo config('home_static'); ?>/images/preview_s3.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
									rel="{gallery: 'gal1', smallimage: '<?php echo config('home_static'); ?>/images/preview_m4.jpg',largeimage: '<?php echo config('home_static'); ?>/images/preview_l4.jpg'}">
	    							<img src="<?php echo config('home_static'); ?>/images/preview_s4.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
									rel="{gallery: 'gal1', smallimage: '<?php echo config('home_static'); ?>/images/preview_m5.jpg',largeimage: '<?php echo config('home_static'); ?>/images/preview_l5.jpg'}">
	    							<img src="<?php echo config('home_static'); ?>/images/preview_s5.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
									rel="{gallery: 'gal1', smallimage: '<?php echo config('home_static'); ?>/images/preview_m6.jpg',largeimage: '<?php echo config('home_static'); ?>/images/preview_l6.jpg'}">
	    							<img src="<?php echo config('home_static'); ?>/images/preview_s6.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
									rel="{gallery: 'gal1', smallimage: '<?php echo config('home_static'); ?>/images/preview_m7.jpg',largeimage: '<?php echo config('home_static'); ?>/images/preview_l7.jpg'}">
	    							<img src="<?php echo config('home_static'); ?>/images/preview_s7.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
									rel="{gallery: 'gal1', smallimage: '<?php echo config('home_static'); ?>/images/preview_m8.jpg',largeimage: '<?php echo config('home_static'); ?>/images/preview_l8.jpg'}">
	    							<img src="<?php echo config('home_static'); ?>/images/preview_s8.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
									rel="{gallery: 'gal1', smallimage: '<?php echo config('home_static'); ?>/images/preview_m9.jpg',largeimage: '<?php echo config('home_static'); ?>/images/preview_l9.jpg'}">
	    							<img src="<?php echo config('home_static'); ?>/images/preview_s9.jpg"></a>
								</li>
							</ul>
						</div>
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div ">
						...
						<div class="desc mt10">
							...
							<img src="<?php echo config('home_static'); ?>/images/desc1.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo config('home_static'); ?>/images/desc2.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo config('home_static'); ?>/images/desc3.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo config('home_static'); ?>/images/desc4.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo config('home_static'); ?>/images/desc5.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo config('home_static'); ?>/images/desc6.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo config('home_static'); ?>/images/desc7.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo config('home_static'); ?>/images/desc8.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo config('home_static'); ?>/images/desc9.jpg" alt="" />
						</div>
					</div>
					<!-- 商品介绍 end -->

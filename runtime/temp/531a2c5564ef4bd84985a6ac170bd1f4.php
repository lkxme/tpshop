<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"E:\phpStudy\WWW\tpshop\public/../application/admin\view\role\upd.html";i:1533291537;}*/ ?>
...
<script>
    ...
    //让当前角色已有的权限默认选中
    var auth_ids_list = "<?php echo $role['auth_ids_list']; ?>"; // '1,2,3,7,8'
    //split把字符串变成数组
    var arr_ids_list = auth_ids_list.split(',');
    console.log(arr_ids_list);

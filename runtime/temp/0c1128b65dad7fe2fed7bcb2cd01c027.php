<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"G:\www.shop.com\public/../application/admin\view\attribute\upd.html";i:1533118095;}*/ ?>
...
<body>
    ...
    <div class="formbody">
        ...
        <form action="" method="post">
            <!-- 隐藏域 -->
            <input type="hidden" name="attr_id"  value="<?php echo $attribute['attr_id']; ?>"/>
            <ul class="forminfo">
                <li>
                    <label>属性名称</label>
                    <input name="attr_name" value="<?php echo $attribute['attr_name']; ?>" placeholder="请输入属性名称" type="text" class="dfinput" /><i></i>
                </li>
                 <li>
                    <label>商品类型</label>
                ...
                <li>
                    <label>属性值</label>
                    <textarea name='attr_values' cols="" rows="" class="textinput"><?php echo $attribute['attr_values']; ?></textarea>
                    <i>多个属性用|隔开</i>
                </li>
...
<script>
    var attr_type = "<?php echo $attribute['attr_type']; ?>";
    var attr_input_type = "<?php echo $attribute['attr_input_type']; ?>";
    ...
    //让编辑的属性所属商品类型默认选中
    $("select[name='type_id']").val("<?php echo $attribute['type_id']; ?>");

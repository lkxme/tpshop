<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"G:\www.shop.com\public/../application/admin\view\type\add.html";i:1533117063;}*/ ?>
    ...
    <div class="formbody">
        ...
        <form action="" method="post">
            <ul class="forminfo">
                ...
                <li>
                    <label>类型描述</label>
                    <textarea name='mark'  placeholder="请输入商品类型描述" cols="" rows="" class="textinput">
